<?php
  $titulo= "CookBook - Doces e Sobremesas";
  require_once 'includes/admin.php';
 ?>

<div class="parallax-container">
  <div class="parallax"><img src="lib/imagens/doces.jpg"></div>
  <div class="icono"><img src="lib/imagens/icono.png"></div>
  <h2 class="doces">Doces e Sobremesas</h2>
</div>
...
<?php
  ...
  $sql = "SELECT * FROM receitas WHERE categoria = 'Doces e Sobremesas' ORDER BY id_receita DESC";
