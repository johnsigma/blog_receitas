<?php
  $titulo= "CookBook - Saladas e Molhos";
  require_once 'includes/header.php';
 ?>

<div class="parallax-container">
  <div class="parallax"><img src="lib/imagens/salada.jpg"></div>
  <div class="icono"><img src="lib/imagens/icono.png"></div>
  <h6 class="doces">Saladas e Molhos</h6>
</div>
...
<?php
  ...
  $sql = "SELECT * FROM receitas WHERE categoria = 'Saladas e Molhos' ORDER BY id_receita DESC";
